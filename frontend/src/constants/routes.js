...
export const ROUTE_TITLES = {
  ...
  '/teacher/my-classes': 'My Assigned Classes',
  '/teacher/attendance': 'Attendance Register',
  '/teacher/assignments': 'Assignments',
  '/teacher/lesson-planner': 'AI Lesson Planner',
  '/teacher/quiz-generator': 'AI Quiz Generator',
  '/teacher/homework-review': 'Homework Review Workspace',
  '/teacher/gradebook': 'Gradebook Manager',
  '/teacher/study-materials': 'Study Materials',
  '/teacher/student-analytics': 'Student Performance Analytics',
