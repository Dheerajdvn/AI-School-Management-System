...
export default function StudentStudyMaterialsPage() {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      setMaterials([
        { id: 1, title: 'Algebra Basics', type: 'PDF', subject: 'Mathematics', class: 'Class 10-A', size: '2.4 MB', uploadedAt: '2026-07-20' },
        { id: 2, title: 'Physics Lab Manual', type: 'PDF', subject: 'Physics', class: 'Class 11-A', size: '5.1 MB', uploadedAt: '2026-07-19' },
        { id: 3, title: 'Chemistry Presentation', type: 'PPT', subject: 'Chemistry', class: 'Class 10-B', size: '8.3 MB', uploadedAt: '2026-07-18' },
        { id: 4, title: 'English Essay Guide', type: 'DOCX', subject: 'English', class: 'Class 12-A', size: '1.2 MB', uploadedAt: '2026-07-17' },
        { id: 5, title: 'Math Tutorial Video', type: 'Video', subject: 'Mathematics', class: 'Class 10-A', size: '45 MB', uploadedAt: '2026-07-16' },
        { id: 6, title: 'Bio Diagrams', type: 'PDF', subject: 'Biology', class: 'Class 10-B', size: '3.7 MB', uploadedAt: '2026-07-15' },
      ])
      setLoading(false)
    }, 600)
...
.smp-page .material-actions { display: flex; gap: 0.25rem; flex-shrink: 0; }
