  ...
  return (
    <div className="sp-page">
      <div className="row g-3 mb-4">
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-book text-primary" /></div><div className="stat-content"><span className="stat-label">My Courses</span><span className="stat-value">{stats.myCourses}</span></div></div></div>
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-card-text text-primary" /></div><div className="stat-content"><span className="stat-label">Assignments</span><span className="stat-value">{stats.assignmentsDue}</span></div></div></div>
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-check-circle text-primary" /></div><div className="stat-content"><span className="stat-label">Completed</span><span className="stat-value">{stats.completedAssignments}</span></div></div></div>
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-calendar-check text-primary" /></div><div className="stat-content"><span className="stat-label">Attendance</span><span className="stat-value">{stats.attendance}%</span></div></div></div>
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-graph-up text-primary" /></div><div className="stat-content"><span className="stat-label">GPA</span><span className="stat-value">{stats.gpa}</span></div></div></div>
        <div className="col-6 col-md-4 col-xl-2"><div className="stat-card shadow-xs"><div className="stat-icon"><i className="bi bi-robot text-primary" /></div><div className="stat-content"><span className="stat-label">AI Tutor Qs</span><span className="stat-value">{stats.aiQuestions}</span></div></div></div>
      </div>
